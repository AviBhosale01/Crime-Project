...
*   **🧠 AI Predictive Models & Multi-Model Leaderboards**:
    *   *Incident Severity Suite*: Multi-model comparison suite evaluating **Random Forest, XGBoost, LightGBM, and Soft Voting Ensembles** with out-of-sample confusion matrices, 5-fold cross-validation, and interactive leaderboards.
    *   *Recidivism Risk Forecaster*: Multi-model regression suite comparing **Random Forest, XGBoost, LightGBM, and Weighted Voting Ensembles** with $R^2$, MAE, RMSE, and leaderboards.
